                        ...
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center">
                                    <input type="color" name="color_picker" id="color_picker" value="{{ old('color', $category->color) }}" class="h-8 w-8 rounded mr-2">
                                    <input type="text" name="color" id="color" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" value="{{ old('color', $category->color) }}" required>
                                </div>
