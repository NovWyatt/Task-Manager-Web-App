    ...
    <form wire:submit.prevent="saveTask">
        <div class="shadow sm:rounded-md sm:overflow-hidden">
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                ...
                @if($taskId)
                    <div>
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="file-upload"
                                        ...
                                        <input id="file-upload" wire:model="attachments" type="file" multiple
                                            class="sr-only">
                                    </label>
                        ...
                        @if($taskId && count($existingAttachments) > 0)
                            <div class="mt-4">
            ...
            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                <button type="button"
                    class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 mr-2"
                    wire:click="cancel">
                    Cancel
                </button>
                <button type="submit"
