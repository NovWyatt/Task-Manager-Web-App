                        ...
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input type="date" name="start_date" id="start_date" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" value="{{ old('start_date') }}">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input type="date" name="end_date" id="end_date" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" value="{{ old('end_date') }}">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <select id="status" name="status" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" required>
                                            <option value="not_started" {{ old('status') == 'not_started' || old('status') == null ? 'selected' : '' }}>Not Started</option>
