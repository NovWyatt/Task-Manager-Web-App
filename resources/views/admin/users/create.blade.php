                            ...
                            <div>
                                ...
                                <div class="mt-2 space-y-2">
                                    ...
                                    <div class="flex items-center">
                                        <input id="role_{{ $role->id }}" name="roles[]" type="checkbox" value="{{ $role->name }}" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" {{ old('roles') && in_array($role->name, old('roles')) ? 'checked' : '' }}>
